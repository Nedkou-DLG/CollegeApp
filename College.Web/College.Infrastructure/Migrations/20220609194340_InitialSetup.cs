        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EGN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmployeedByDepartmentId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_Departments_DepartmentManagerId",
                        column: x => x.DepartmentManagerId,
                        principalTable: "Departments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Teachers_Departments_EmployeedByDepartmentId",
                        column: x => x.EmployeedByDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Evalutation = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_DepartmentManagerId",
                table: "Teachers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_EmployeedByDepartmentId",
                table: "Teachers",
                column: "EmployeedByDepartmentId");
        }
